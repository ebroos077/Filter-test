...
const houses = [
  {proptype:"Single-Family Home",       city:"Las Vegas, NV",      loanamt:420000,   loan:"Conventional", rate:6.75, refi:false, type:"Rehab Bridge", term:30, link:"https://bluecactuslending.com/casestudy-1"},
...
function applyFilters() {
  ...
  filteredList = houses.filter(function (h) {
    ...
    if (query) {
      ...
      const abbr = parts[1] ? parts[1].toLowerCase() : "";
      const fullState = Object.keys(stateMap).find(function (k) { return stateMap[k] === abbr; });
  ...
  if      (st === "loanamt-asc")  filteredList.sort(function (a, b) { return a.loanamt - b.loanamt; });
  else if (st === "loanamt-desc") filteredList.sort(function (a, b) { return b.loanamt - a.loanamt; });
  else if (st === "rate-asc")     filteredList.sort(function (a, b) { return a.rate - b.rate; });
  else if (st === "rate-desc")    filteredList.sort(function (a, b) { return b.rate - a.rate; });
  else if (st === "term-asc")     filteredList.sort(function (a, b) { return a.term - b.term; });
  else if (st === "term-desc")    filteredList.sort(function (a, b) { return b.term - a.term; });
...
function renderCards() {
  ...
  if (countEl) {
    countEl.textContent =
      ...
      " propert" + (filteredList.length === 1 ? "y" : "ies");
  }
